(() => {
    ...
    function initSliders() {
        bildSliders();
        if (document.querySelector(".time__slider")) {
            new core(".time__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                loop: true,
                navigation: {
                    prevEl: ".time__arrow_left",
                    nextEl: ".time__arrow_right"
                },
                on: {}
            });
            let mainsliderImages = document.querySelectorAll(".review-slider__image");
            let mainsliderDots = document.querySelectorAll(".review-slider__dots .swiper-pagination-bullet");
    ...
    da.init();
    let filterContainer = document.querySelector(".coffee-house__list");
    let galleryItems = document.querySelectorAll(".coffee-house__item");
    if (filterContainer && galleryItems) filterContainer.addEventListener("click", (event => {
        if (event.target.classList.contains("coffee-house__button")) {
            filterContainer.querySelector("._active").classList.remove("_active");
            event.target.classList.add("_active");
            let filterValue = event.target.getAttribute("data-filter");
            galleryItems.forEach((item => {
                if (item.classList.contains(filterValue) || "all" === filterValue) {
